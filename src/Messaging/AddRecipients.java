 ...
 * @author Jacque
 */
public class AddRecipients extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search Message Recipients");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "First Name", "Middle Name", "Last Name", "Grade", "Parents", "Guardian"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddRecipients.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddRecipients().setVisible(true);
            }
        });
    }
