...
public class Student {
    ...
    public Student(String firstName, String lastName, String grade, String gender,String nationality, int imageID, String birthDate, String fathersName, int fPhone,
